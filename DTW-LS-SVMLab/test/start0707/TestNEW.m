...
TXT= importdata('C:\Documents and Settings\Administrator\桌面\cjy\2016\8\data\600030.txt');
%TXT= importdata('C:\Documents and Settings\Administrator\桌面\cjy\2016\7\data\zxzq0703.txt');
TXT=(TXT.textdata(2:end-2,5))';% end:2015-03~06:2864-2933  %+2000
TXT=str2double(TXT);
