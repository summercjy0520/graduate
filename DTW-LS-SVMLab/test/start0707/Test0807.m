...
% if min(dd2)==min0
if mean(dd2(1:5))==min0
    SS0=SS1;
    H0=TT1;
    cjy=0;
    class(zis)=1;
elseif mean(dd3(1:5))==min0
    SS0=SS2;
    H0=TT2;
    cjy=1;
    class(zis)=2;
elseif mean(dd4(1:5))==min0
    SS0=SS3;
    H0=TT3;
    cjy=2;
    class(zis)=3;
elseif mean(dd5(1:5))==min0
    SS0=SS4;
    H0=TT4;
    cjy=3;
    class(zis)=4;
elseif mean(dd6(1:5))==min0
    SS0=SS5;
    H0=TT5;
    cjy=4;
    class(zis)=5;
elseif mean(dd7(1:5))==min0
    SS0=SS6;
    H0=TT6;
    cjy=5;
    class(zis)=6;
elseif mean(dd8(1:5))==min0
    SS0=SS7;
    H0=TT7;
    cjy=6;
    class(zis)=7;
elseif mean(dd9(1:5))==min0
    SS0=SS8;
    H0=TT8;
    cjy=7;
    class(zis)=8;
