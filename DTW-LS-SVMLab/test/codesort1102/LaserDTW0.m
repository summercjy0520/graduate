...
% 第一次计算距离
dd1=pdist2(S,Q,'seuclidean');%EH distance
% dd1=zeros(z,1);%DTW distance
% for ii=1:z
%     dd1(ii)=Dtwdistance(S(ii,:),Q);
% end
...
% 第二次计算距离
dd2=pdist2(F1,F2,'seuclidean');%EH distance
% dd2=zeros(z,1);%DTW distance
% for ii=1:z
%     dd2(ii)=Dtwdistance(F1(ii,:),F2);
% end
