...
%     if (cjy1(f)==0)
%         cjy(f)=exp((1)*cjy1(f))*2; %+exp((-1/2)*cjy2(f));
%     elseif(cjy2(f)==0)
%         cjy(f)=exp((1)*cjy2(f))*2;
%     if (cjy1(f)==0||cjy2(f)==0)
%         cjy(f)=(exp((-1/2)*cjy1(f))+exp((-1/2)*cjy2(f)));%*(1/2)
%     else
% %         namda=log(cjy1(f)/cjy2(f))/(cjy1(f)/cjy2(f)+1);
%         if (cjy1(f)>cjy2(f))
% %             namda=(log(cjy1(f)/cjy2(f))+cjy2(f))/(cjy1(f)+cjy2(f));
%             namda=log(cjy1(f)/cjy2(f))/(cjy1(f)/cjy2(f)+1);
%             namda=namda-floor(namda);
%         else
%             namda=log(cjy2(f)/cjy1(f))/(cjy1(f)/cjy2(f)+1);
%             namda=namda-floor(namda);
% %             namda=(log(cjy2(f)/cjy1(f))+cjy2(f))/(cjy1(f)+cjy2(f));
%         end
