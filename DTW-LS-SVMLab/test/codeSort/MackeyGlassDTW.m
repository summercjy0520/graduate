...
[TXT,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\2016\10\data\MG700.xls');
TXT=TXT(:,1);
% TXT= importdata('C:\Documents and Settings\Administrator\桌面\cjy\2016\10\MackeyGlass.txt');
[TXT,T1]=mapminmax(TXT',-1,1);
TXT=TXT(1:end)';
...
ylabel('Values of Mackey-Glass database');
title('DTW:mae= ,rmse= ');
...
for i=1:mn
    ...
    PW=PW+abs(Xt(i)-prediction(i))/Xt(i);
