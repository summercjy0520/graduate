...
[TXT,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\2016\10\data\internet-traffic.xls');
...
if VV(t)<0.40
    ...
    YT(t)=1;
    A1(t)=t;
elseif VV(t)>=0.40&&VV(t)<1.61
    TT2(t)=VV(t);
    YT(t)=2;
    A2(t)=t;
elseif VV(t)>=1.61&&VV(t)<1.8
    TT3(t)=VV(t);
    YT(t)=-1;
    A3(t)=t;
else
...
ylabel('Values of Internettraffic database');
title('DTW:mae= ,rmse= ');
