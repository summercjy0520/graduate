...
TXT= importdata('C:\Documents and Settings\Administrator\桌面\cjy\2016\9\data\UCR_TS_Archive_2015\CBF\CBF_TRAIN');
TXT1= importdata('C:\Documents and Settings\Administrator\桌面\cjy\2016\9\data\UCR_TS_Archive_2015\CBF\CBF_TEST');
TXT=[TXT;TXT1];
TXT=TXT(:,2);
