...
[TXT1,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\2016\10\RATP\RATP5.xls');
...
if VV(t)<-0.8841
    ...
    YT(t)=1;
    A1(t)=t;
elseif VV(t)>=-0.8841&&VV(t)<-0.8293
    TT2(t)=VV(t);
    YT(t)=2;
    A2(t)=t;
elseif VV(t)>=-0.8293&&VV(t)<0.6586
    TT3(t)=VV(t);
    YT(t)=-1;
    A3(t)=t;
else
...
for i=1:ww
    ...
    if diff<17
        classR(i)=1;
    elseif diff>=17&&diff<26
        classR(i)=2;
    elseif diff>=26&&diff<245
        classR(i)=-1;
    else
        classR(i)=-2;
