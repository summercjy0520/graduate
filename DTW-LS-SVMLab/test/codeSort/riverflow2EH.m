...
[TXT,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\2016\10\data\riverflow2.xls');

C=100;%向前预测多少个样本点
prediction=zeros(C-1,1);
...
% prediction(jia) =TXT(h0+jia)+tempx;
end
...
ylabel('Values of riverflow2 database');
title('DTW:mae= ,rmse= ,mape=');
