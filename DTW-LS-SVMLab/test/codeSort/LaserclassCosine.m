...
if VV(t)<0.25
    ...
    YT(t)=1;
    A1(t)=t;
elseif VV(t)>=0.25&&VV(t)<0.8
    TT2(t)=VV(t);
    YT(t)=2;
    A2(t)=t;
elseif VV(t)>=0.8&&VV(t)<1.8
    TT3(t)=VV(t);
    YT(t)=-1;
    A3(t)=t;
else
...
[SSS,H,cjy,Xs]=CosineMI(H0,SS0,SSS,Xs,KK,km,k0,th,qq);
...
% tempx = predictknn({SSS,H,'f',gam,sig2,'RBF_kernel'},Xs,cjy,1);
