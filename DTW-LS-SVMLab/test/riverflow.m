...
[TXT,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\12月\shuju\riverflow.xls');
...
ylabel('Values of riverflow database');
title('the example n of KNN');
