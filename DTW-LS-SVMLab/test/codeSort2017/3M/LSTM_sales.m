    ...
    for m=1:data_num
        ...
        if(Error_Cost(1,iter)<cost_gate)
            ...
            [   weight_input_x,...
                ...
                weight_outputgate_x,...
                weight_outputgate_c,...
                weight_preh_h ]=LSTM_updata_sales_weight(m,yita,Error,...
                                                   weight_input_x,...
                                                   weight_input_h,...
                                                   weight_inputgate_x,...
                                                   weight_inputgate_c,...
