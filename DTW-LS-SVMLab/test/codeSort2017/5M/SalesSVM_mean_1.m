...
TXT=importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\MIToolbox2.11\LS-SVMLab v1.7(R2006a-R2009a)\data\ARIMA.txt');
...
prediction(zis) = predict({X,Ytra,'f',gam,sig2,'RBF_kernel'},Xs,1);
