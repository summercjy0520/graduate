...
while(isempty(SS)==0)
    ...
    if index<width/2
        ...
        temp(index+1:width,:)=S(index+1:width-index+1,:);
    elseif index>z-width/2
        temp(1:width/2,:)=S((index-width/2):(index-1),:);
        temp(width/2+1:width/2+z-index+1,:)=S(index:end,:);
    else
        temp(1:width/2,:)=S((index-width/2):(index-1),:);
        temp(width/2+1:width,:)=S(index+1:index+width/2,:);
    end
