...
% TXT=importdata('C:\Documents and Settings\Administrator\桌面\cjy\2017\6\15\data\household_power_consumption.txt');
[XX,TX,RAW] = xlsread('C:\Documents and Settings\Administrator\桌面\cjy\2017\6\15\data\Tourism_download.xlsx');
...
% Ytra=X(s+qq:end);
% % Q=Xt;
% [Ytra,T1]=mapminmax(Ytra');

% dd1=NHEH0306(S,Q);%NHDTWnew0
dd1=NHDTWnew0(S,Q);
