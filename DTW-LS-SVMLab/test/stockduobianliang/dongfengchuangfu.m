...
TXT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\dfcf.txt');
TXT=(TXT.textdata(28:1386,5))';% end:1314-1386,1256-1298,1248(1221),1212(1176)
TXT=str2double(TXT);
...
TYT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\cybzs.txt');
TYT=(TYT.textdata(2:1360,8))'; % end:2015-03~06:5917-5986
TYT=str2double(TYT);
