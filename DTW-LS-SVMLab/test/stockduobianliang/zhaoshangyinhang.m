...
TXT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\zsyh.txt');
TXT=(TXT.textdata(2002:3127,5))';% end:3287,3217,3157,3127
TXT=str2double(TXT);
...
TYT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\szzs.txt');
TYT=(TYT.textdata(4866:5991,5))'; % end:2015-03~06:5917-5986
TYT=str2double(TYT);
