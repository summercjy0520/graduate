...
TXT=(TXT.textdata(2002:3036,5))';% end:2015-03~06:2864-2933  %+2000
TXT=str2double(TXT);
[TXT,T1]=mapminmax(TXT);
TXT=TXT(1:end)';

TYT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\zxzq.txt');
% TYT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2016\6\data\main\zsyh.txt');
TYT=(TYT.textdata(2002:3036,5))';% end:3287,3217,3157,3127
TYT=str2double(TYT);
