...
if VV(t)<0.18
    ...
    YT(t)=1;
    A1(t)=t;
elseif VV(t)>=0.18&&VV(t)<0.23
    TT2(t)=VV(t);
    YT(t)=2;
    A2(t)=t;
elseif VV(t)>=0.23&&VV(t)<0.32
    TT3(t)=VV(t);
    YT(t)=-1;
    A3(t)=t;
else
...
for i=1:ww
    ...
    if diff<0.19
        classR(i)=1;
    elseif diff>=0.19&&diff<0.24
        classR(i)=2;
    elseif diff>=0.24&&diff<0.32
        classR(i)=-1;
    else
        classR(i)=-2;
