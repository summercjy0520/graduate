...
%FCMClust.m采用模糊C均值对数据集data聚为cluster_n类
%用法：
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%?
%子函数1
function U=initfcm(cluster_n,data_n)%初始化fcm的隶属度函数矩阵?%?输入:
%cluster_n----聚类中心个数
%data_n----样本点数
%输出：
%U----初始化的隶属度矩阵
U=rand(cluster_n,data_n);col_sum=sum(U);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%??
%子函数3
function out=distfcm(center,data)%计算样本点距离聚类中心的距离
%输入：
%center----聚类中心
%data----样本点
%输出：
