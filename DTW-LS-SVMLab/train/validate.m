...
stringSet('PopulationType',o.PopulationType,{
'doubleVector','custom','bitString'
});
...
stringSet('MigrationDirection',o.MigrationDirection,{
'both','forward'
});
stringSet('Display',o.Display,{
'off','none','iter','final','diagnose'
});
stringSet('Vectorized',o.Vectorized,{
'on','off'
});
...
for i = 1:length(value)
    ...
    if iscell(candidate)
      ...
      %  
        {@outputfcn,p1,p2}
%The following code gets rid of extra braces,
